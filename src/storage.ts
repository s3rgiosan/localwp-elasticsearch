...
const ENABLED = 'elasticsearchEnabled';
const VERSION = 'elasticsearchVersion';
const PORT = 'elasticsearchPort';

export const SUPPORTED_VERSIONS = ['5.2', '7.17.28'] as const;
export type EsVersion = typeof SUPPORTED_VERSIONS[number];
export const DEFAULT_VERSION: EsVersion = '7.17.28';
...
export function initStorage(): void {
	try {
		...
		console.error('[elasticsearch] failed to resolve siteData service:', err);
	}
}
